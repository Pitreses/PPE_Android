...
public class listeTarifsCPHActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liste_tarifs_cph);
        final Spinner spinnerClasses = (Spinner) findViewById(R.id.spinnerClasses);
        new listeTarifsCPHActivity.BackTaskClasses().execute();
    }
    ...
    private class BackTaskClasses extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                Request request = new Request.Builder()
                        .url("http://10.0.2.2/PPE/DAO/listeCPHDAO.php")
                        .build();
        ...
        protected void onPostExecute(Void result) {
            ArrayAdapter<String> arrayAdapterClasses = new
                    ArrayAdapter<String>(listeTarifsCPHActivity.this,
