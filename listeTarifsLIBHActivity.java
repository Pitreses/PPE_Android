...
public class listeTarifsLIBHActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liste_tarifs_libh);
        final Spinner spinnerClasses = (Spinner) findViewById(R.id.spinnerClasses);
        new listeTarifsLIBHActivity.BackTaskClasses().execute();
    }
    ...
    private class BackTaskClasses extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                Request request = new Request.Builder()
                        .url("http://10.0.2.2/PPE/DAO/listeLIBHDAO.php")
                        .build();
                ...
                for (int i = 0; i < jsonArrayClasses.length(); i++) {
                    ...
                    String tarif = jsonClasse.getString("CodeCateg") + " " + jsonClasse.getString("tarifH")+"€"+ " "+jsonClasse.getString("duree")+"h";
        ...
        protected void onPostExecute(Void result) {
            ArrayAdapter<String> arrayAdapterClasses = new
                    ArrayAdapter<String>(listeTarifsLIBHActivity.this,
